...
const { issueToken, storeSession, verifyTokenDetailed, isEphemeralSessionSecret } = require('../../../../core/security/session-cache');
...
const { normalizeRoles, rolesToStoredValue, accountHasRole, accountHasAnyRole, getPrimaryRole } = require('../../../../core/security/role-utils');
...
const SERVICE_CONFIG_FILE = path.join(PROJECT_ROOT, 'service-config.json');
