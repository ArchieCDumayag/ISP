...
- Create, list, update, filter, and delete operating expenses.
...
- All nine moved browser files are byte-identical to their pre-migration versions.
...
- `npm run refactor:finance` verifies the descriptor, retirement of two root entries, nine web files, server wiring, canonical Core dependencies, route definitions, and retained reporting-asset contracts.
