...
const checks = [
  ...
  // These pages are module-owned but disabled by the default feature profile.
  { path: '/payment-confirmation-queue.html', status: 404 },
  { path: '/payment-confirmation-queue-history.html', status: 404 },
